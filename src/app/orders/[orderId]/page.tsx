                ...
                <div className="w-full bg-base-300 p-4 rounded-2xl space-y-4">
                  <div className="flex justify-between">
                    ...
                    <span className="text-primary text-lg font-semibold">
                      $
                      {(order!.totalOrderPrice - order!.shippingPrice).toFixed(
                        2
                      )}
                    </span>
                  </div>
          ...
          <div className="space-y-6">
            ...
            <div className="card bg-base-300 rounded-2xl shadow-md print:shadow-none">
              <div className="card-body p-4 md:p-6">
                ...
                {!order?.isPaid && (
                  <RazorPayPaymentBtn amount={Number(order.totalOrderPrice)} orderIdDb={String(order._id)} />
                )}
