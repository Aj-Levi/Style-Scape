        ...
        <div className="relative w-full overflow-hidden">
          ...
          >
            {duplicatedBrands.map((brand, index) => (
              ...
              >
                <div className="w-20 h-20 flex items-center justify-center bg-white rounded-full shadow-md mb-3 hover:scale-110 transition-transform duration-300 relative">
                  <Image
                    src={brand.logo}
                    alt={`${brand.name} logo`}
                    fill
